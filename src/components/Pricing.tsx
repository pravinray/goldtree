...
const Pricing = () => {
  ...
  return (
    ...
    >
      ...
      >
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14135.697030255!2d85.33342825972038!3d27.65781501937278!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb175804d46333%3A0x407a3f6860e99df2!2sImadol%2C%20Mahalaxmi!5e0!3m2!1sen!2snp!4v1713872587276!5m2!1sen!2snp"
          width="95%"
          height="580"
          style={{ border: 0 }}
          loading="lazy"
      ...
      <div className="container px-6 md:px-12 mt-3">
                ...
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:mb-0 md:w-6/12 md:px-3 lg:mb-12 lg:w-full lg:px-6 xl:w-6/12">
                  <div className="align-start flex">
                    ...
                    <div className="ml-6 grow">
                      ...
                      <p className="text-neutral-500"> info@goldtree.com.np</p>
                    </div>
                  </div>
                </div>
                <div className="w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:w-full lg:px-6 xl:mb-12 xl:w-6/12">
                  <div className="align-start flex">
                    ...
                    <div className="ml-6 grow">
                      ...
                      <p className="text-neutral-500"> +977 9824877222</p>
                    </div>
                  </div>
                </div>
              </div>
